...
/*   Updated: 2024/10/27 13:34:59 by sfarren          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	sort_big(t_stack_node **stack_a, t_stack_node **stack_b)
{
	...
	if (len-- > 3)
		pb(stack_a, stack_b);
	// Make sure stack b is in descending order
	...
	while (len-- > 3 && !stack_sorted(*stack_a))
	{
		...
		// ft_printf("---STACK A - AFTER INITIALISE NODES---\n");
		// print_stack(*stack_a, "A");
		// ft_printf("---STACK B - AFTER INITIALISE NODES---\n");
